  ...
  return (
    <main className="grid min-h-screen grid-cols-2">
      <div className='relative flex flex-col items-start justify-between overflow-x-hidden border-r border-white/10 bg-[url("../assets/bg-stars.svg")] bg-cover px-28 py-16'>
        <div className="blur- absolute right-0 top-1/2 h-[288px] w-[526px] -translate-y-1/2 translate-x-1/2 rounded-full bg-purple-700 opacity-50 blur-full"></div>
        ...
        <div className="space-y-5">
          <Image src={nlwLogo} alt="Logo for NLW Spacetime" />
